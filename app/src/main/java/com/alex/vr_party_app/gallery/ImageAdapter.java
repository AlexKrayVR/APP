...
import com.alex.vr_party_app.databinding.ImageCardBinding;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ImageViewHolder(ImageCardBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
...
//       Picasso.with(mContext).load(uploadCurrent.getUrl()).resize(1000, 800).centerInside().placeholder(R.drawable.description).into(holder.image_view);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(ImageCardBinding binding) {
